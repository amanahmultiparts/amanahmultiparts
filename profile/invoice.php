...
// Anda tetap bisa menggunakan kode ini untuk mendapatkan id invoice
if (isset($_GET['idinvoiceprint'])) {
    $idinvoiceprint = $_GET['idinvoiceprint'];
} else {
    // Tampilkan pesan error atau redirect ke halaman lain jika idinvoiceprint tidak tersedia
    exit("ID Invoice tidak tersedia.");
}

// Kode pemeriksaan login dihapus dari sini
...
<head>
    ...
    <link rel="icon" href="../../../../assets/icons/<?php echo $logo; ?>" type="image/png">
